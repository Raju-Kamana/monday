...
let BankService = class BankService {
    ...
    addAccount(account) {
        return this.http.post("http://localhost:4002/create", account).toPromise().then(data => console.log(data));
    }
    getDetails(value) {
...
let FundsTransferComponent = class FundsTransferComponent {
    constructor(bankService, router) {
        this.bankService = bankService;
        this.router = router;
    }
...
FundsTransferComponent.ctorParameters = () => [
    { type: _bank_service__WEBPACK_IMPORTED_MODULE_2__["BankService"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
];
...
let GetAccountComponent = class GetAccountComponent {
...
GetAccountComponent.ctorParameters = () => [
    { type: _bank_service__WEBPACK_IMPORTED_MODULE_2__["BankService"] }
];
...
let ShowAccountsComponent = class ShowAccountsComponent {
    constructor(bankService) {
        this.bankService = bankService;
...
ShowAccountsComponent.ctorParameters = () => [
    { type: _bank_service__WEBPACK_IMPORTED_MODULE_2__["BankService"] }
];
...
TransactionListComponent.ctorParameters = () => [
    { type: _bank_service__WEBPACK_IMPORTED_MODULE_2__["BankService"] }
];
